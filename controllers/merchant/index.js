...
const addProduct = async (req, res) => {
  ...
  if (req.user && req.user.user_role === "Admin") {
    try {
      ...
      const query = "INSERT INTO products (merchant_id, product_name, description, selling_price, discount, stock_quantity, category_id, main_image_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
...
const updateProduct = async (req, res) => {
  ...
  if (req.user && req.user.user_role === "Admin") {
    try {
      ...
      const query = "UPDATE products SET product_name = ?, description = ?, selling_price = ?, discount = ?, stock_quantity = ?, category_id = ?, main_image_url = ? WHERE product_id = ? AND merchant_id = ?"
